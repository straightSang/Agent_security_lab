# Threat Model v0.4 — Day 5 보관본

> Day 6의 현재 위협 모델은 [ThreatModel0.5.md](ThreatModel0.5.md)다. 아래는 Day 5 Authorization·Approval 회귀 불변조건을 이해하기 위한 보관 자료이며, Day 6의 구현 범위·실험 ID·측정 기준은 정의하지 않는다.
