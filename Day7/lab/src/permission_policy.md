# 권한 정책 v0.6 — Day 7 Indirect Prompt Injection Fixture

> Day 7은 Policy allow/deny 규칙을 완화하지 않는다. JSON fixture는 고정된 실험 입력과 기대값만 제공하며, 기존 Policy·Authorization·Approval·Runtime 경계를 그대로 사용한다.
