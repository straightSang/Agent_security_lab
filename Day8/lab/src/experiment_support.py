"""Day 8 fixture의 최소 sandbox와 실험 증거 기록 지원 함수.
...
def make_experiment_runtime(
    ...
    runtime = build_runtime(trace_path=run_trace_path, sandbox_root=sandbox_root)
...
def record_control_plane_snapshot(
    ...
    *,
    ...
    """D8-E03/E04의 공격 전후 보안 상태와 digest를 trace에 남긴다."""
