...
- 실행 번호: `run-d8-i03-80ad89fa413e4332acbcf64b3a1502ba`
- 사건 수: 24
...
| 7 | 승인 상태 | `call-d8-i03-pending` | approval=pending; approval_id=apr_a4b92c1688a048cf9633332825fbf26f; required_approver=user-001 |
...
| 14 | 승인 상태 | `call-d8-i03-approved` | approval=approved; approval_id=apr_a4b92c1688a048cf9633332825fbf26f; required_approver=user-001 |
| 15 | 승인 상태 | `call-d8-i03-approved` | approval=consumed; approval_id=apr_a4b92c1688a048cf9633332825fbf26f; required_approver=user-001 |
...
| 22 | 승인 상태 | `call-d8-i03-replay` | approval=pending; approval_id=apr_6be0c0b5cd2c4145a1b2edffe20d9ed8; required_approver=user-001 |
