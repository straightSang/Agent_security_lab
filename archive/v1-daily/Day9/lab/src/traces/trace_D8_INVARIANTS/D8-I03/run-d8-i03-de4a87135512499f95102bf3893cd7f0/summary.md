...
- 실행 번호: `run-d8-i03-de4a87135512499f95102bf3893cd7f0`
- 사건 수: 24
...
| 7 | 승인 상태 | `call-d8-i03-pending` | approval=pending; approval_id=apr_97614db7e2b740928f90c76b77fd0695; required_approver=user-001 |
...
| 14 | 승인 상태 | `call-d8-i03-approved` | approval=approved; approval_id=apr_97614db7e2b740928f90c76b77fd0695; required_approver=user-001 |
| 15 | 승인 상태 | `call-d8-i03-approved` | approval=consumed; approval_id=apr_97614db7e2b740928f90c76b77fd0695; required_approver=user-001 |
...
| 22 | 승인 상태 | `call-d8-i03-replay` | approval=pending; approval_id=apr_d250b534299043da9d3253a135691b4f; required_approver=user-001 |
